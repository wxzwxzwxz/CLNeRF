...
# Ours_delete
y_task1_ours = [31.10594383, 31.08608215, 31.08326109, 31.14672065, 31.17160556, 31.16934333, 31.21352767, 31.21391845, 31.23308929, 31.27657937, 31.30377506, 31.28495348, 31.3488473, 31.34661324, 31.36720066, 31.42128152, 31.42764688, 31.48431043, 31.46231979, 31.47216277]
...
# Finetune_delete
y_task1_finetune = [26.20753562, 24.98176461, 24.22772292, 23.63469227, 23.03055084, 22.83100988, 22.71544374, 22.22744146, 21.91749955, 21.89761747, 21.69167026, 21.52148834, 21.42790694, 21.31998741, 21.22789704, 21.07299054, 21.00823591, 20.91836537, 20.88175464, 20.81225889]
...
if task == 0:
    ...
    plt.savefig('task12_delete.jpg', format='jpg', bbox_inches='tight', dpi=300, transparent=True)
elif task == 1:
    fig.legend(('Ours','Finetune'),frameon=False, loc='upper center',ncol=2,handlelength=4) # 图例
